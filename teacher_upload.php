...
<div class="login">
	...
	$link = "https://www.youtube.com/embed/$video_id?$query_string";
	...
	<div style="margin-left: 200px;padding-top: 50px;">
		<form method="POST">
			...
			<?php
				$query = "SELECT cid, name FROM chapter";
				$result = mysqli_query($conn, $query);
			?>
			<label for="select-chapter">Select a Chapter:</label>
			<select id="select-chapter" onchange="showSelectedChapter(this)">
			...
			<input type="text" id="chapter-id" name="chapter" readonly>
			
			<script>
				function showSelectedChapter(selectElement) {
					var selectedCid = selectElement.value;
					var selectedName = selectElement.options[selectElement.selectedIndex].text;

					document.getElementById("chapter-id").value = selectedCid;
			...
			<input type="submit" name="upload-video" value=" Click to upload URL" onclick="alert('video uploaded Successfully')" style="margin-left: 50px;padding-bottom:2px;margin-bottom: 10px;">
		</form>
	</div>
    ...
    <div class="row-fluid">
		...
		<br>
				<!-- <form method="post" enctype="multipart/form-data" >
					...
					<input name="UPLOAD_MAX_FILESIZE" value="51943040"  type="hidden"/>
