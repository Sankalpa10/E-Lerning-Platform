...
<center>
  ...
  <a href="teacher_upload.php?t=1"><div style="background: url(images/macro.jpg);color: #f0f8ff;" class="dash-opt">SFT</div></a>
  <a href="teacher_upload.php?t=2"><div style="background: url(images/macro.jpg);color: #f0f8ff;" class="dash-opt">ET</div></a>
   <a href="teacher_upload.php?t=3"><div style="background: url(images/macro.jpg);color: #f0f8ff;" class="dash-opt">BST</div></a>
  <a href="teacher_upload.php?t=4"><div style="background: url(images/macro.jpg);color: #f0f8ff;" class="dash-opt">IT</div></a>
</center>
</div>
